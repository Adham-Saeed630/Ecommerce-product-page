...
const lightboxSlice = createSlice({
    ...
    initialState: {
        ...
        images:[
            {
                mainImage: "../src/assets/image-product-1.jpg",
                thumbnail: "../src/assets/image-product-1-thumbnail.jpg"
            },
            {
                mainImage: "../src/assets/image-product-2.jpg",
                thumbnail: "../src/assets/image-product-2-thumbnail.jpg"
            },
            {
                mainImage: "../src/assets/image-product-3.jpg",
                thumbnail: "../src/assets/image-product-3-thumbnail.jpg"
            },
            {
                mainImage: "../src/assets/image-product-4.jpg",
